...
public class HyperInput : MonoBehaviour
{
    ...
    private List<Axis> axes = new List<Axis>()
        { new Axis("Horizontal", KeyCode.D, KeyCode.A, KeyCode.RightArrow, KeyCode.LeftArrow, 0.2f, 0.1f),
          new Axis("Vertical", KeyCode.W, KeyCode.S, KeyCode.UpArrow, KeyCode.DownArrow, 0.2f, 0.1f),
    ...
    void Start()
    {
        // If a copy of the Manager was not found
        if (instance == null)
        {
            // Set a reference to an instance of an object
            instance = this;
        }
